...
class Agent:
    ...
    def model_response(self, state: AgentState) -> AgentState:
        ...
        system_text = """
        You are a helpful File Assistant Agent. Your job is to help users search for information, answer questions, and assist with simple tasks related to files on their computer.
        ## Capabilities:
        ...
        - Use provided tools to search data based on question. Tips: use the write_txt_tool to mark down the related content and answer question based on the record you just marded down.
        - Respond in a concise and friend manner.
